...
\begin{center}
\vspace*{0.4cm}
\includegraphics[width=1.0\linewidth,height=8.3cm,keepaspectratio]{content/assets/crohn-ipi-diffusion/fig3-proposed-solution.png}
\par\vspace{0.35ex}
...
\par\vspace{0.25ex}
{\scriptsize\itshape Figure 5a. Rare-class recall across conditions; synthetic augmentation improves several rare classes.\par}
...
\par\vspace{0.25ex}
{\scriptsize\itshape Figure 5b. Recall advantage relative to the real-only baseline.\par}
\end{minipage}
}%
\end{center}
}
